...
!(function (t, e) {
  ...
  class Ae extends R {
    ...
    _setContent(t, e, i) {
      ...
      s && ((e = this._resolvePossibleFunction(e)) ? (l(e) ? this._putElementInTemplate(c(e), s) : this._config.php ? (s.innerHTML = this._maybeSanitize(e)) : (s.textContent = e)) : s.remove());
    }
    _maybeSanitize(t) {
  ...
  class Pe extends V {
    ...
    _getTemplateFactory(t) {
      return this._templateFactory ? this._templateFactory.changeContent(t) : (this._templateFactory = new Ae({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
    }
