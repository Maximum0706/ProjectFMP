...
!(function (t, e) {
  ...
  function zt(t) {
    return t instanceof Bt(t).phpElement || t instanceof HTMLElement;
  }
  function qt(t) {
  ...
  class Gi extends F {
    ...
    _setContent(t, e, i) {
      ...
      n && ((e = this._resolvePossibleFunction(e)) ? (o(e) ? this._putElementInTemplate(r(e), n) : this._config.php ? (n.innerHTML = this._maybeSanitize(e)) : (n.textContent = e)) : n.remove());
    }
    _maybeSanitize(t) {
