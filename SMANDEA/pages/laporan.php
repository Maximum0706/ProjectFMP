...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/hasilanalisa.php">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Hasil Analisa</span>
                                   ...
                                   <li class="nav-item">
                                        <a class="nav-link active " href="../pages/laporan.php">
                                            <div
                                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <body>
        <div class="container">
            <h2 class="text-center mb-4">Rasio Efisiensi</h2>
            <div class="chart">
                <h3>Hasil analisa rasio efisiensi</h3>
                <div class="chart-container">
                    <div class="chart-line">
                        <div class="chart-label">Tanah Luas</div>
                        <div class="chart-point"></div>
                        <div class="chart-label">Samudera</div>
                        <div class="chart-point"></div>
                        <div class="chart-label">Matangkuli</div>
                        <div class="chart-point"></div>
                        <div class="chart-label">Meurah Mulia</div>
                        <div class="chart-point"></div>
                        <div class="chart-label">Syamtalira Aron</div>
                        <div class="chart-point"></div>
                    </div>
                </div>
            </div>
...
>>>>>>> bcd1395a6e16ef9f0eb36bb378153cc2793fa71f
</html>