...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO variable (variable, type_variable, nama_variabel) VALUES ('$variable', '$type_variable', '$nama_variabel')";
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Tambah Variable</h2>
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" name="type_variable" class="form-control" required>
            </div>
            <div class="form-group">
